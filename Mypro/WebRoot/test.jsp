...
<body>
							...
							<div class="container">
								<div class="row" style="margin-top:  30px">
									<div class="col-lg-12 text-center">
										<h3 class="section-subheading text-muted" style="color:black">袭击事件趋势</h3>
									</div>
								</div>
								<div class="row" style="margin-top:  30px">
									<div class="col-md-6 col-sm-6 portfolio-item">
										<div id="one1" style="height:400px"></div>
									</div>
									<div class="col-md-6 col-sm-6 portfolio-item">
										<div id="one2" style="height:400px"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div style="width: 100%;height: 100%;background-color: #580000">
						...
						<div style="height:100%;width:100%; background-color:#707070">
							<div class="container">
								<div class="row" style="margin-top:  30px">
									<div class="col-lg-12 text-center">
										<h3 class="section-subheading text-muted" style="color:black">袭击事件造成的伤亡分析</h3>
									</div>
								</div>
								<div class="row" style="margin-top:  30px">
									<div class="col-md-6 col-sm-6 portfolio-item">
										<div id="two1" style="height:400px"></div>
									</div>
									<div class="col-md-6 col-sm-6 portfolio-item">
										<div id="two2" style="height:400px"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div style="width: 100%;height: 100%;background-color: #580000">
						...
						<div style="height:100%;width:100%; background-color:#707070">
							<div class="container">
								<div class="row" style="margin-top:  30px">
									<div class="col-lg-12 text-center">
										<h3 class="section-subheading text-muted" style="color:black">袭击事件所使用的武器</h3>
									</div>
								</div>
								<div class="row" style="margin-top:  30px;">
									<div class="col-md-6 col-sm-6 portfolio-item">
										<div id="three1" style="height:600px;width:800px"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div style="width: 100%;height: 100%;background-color: #580000">
						...
						<div style="height:100%;width:100%; background-color:#707070">
							<div class="container">
								<div class="row" style="margin-top:  30px">
									<div class="col-lg-12 text-center">
										<h3 class="section-subheading text-muted" style="color:black">受害者分析</h3>
									</div>
								</div>
								<div class="row" style="margin-top:  30px">
									<div class="col-md-6 col-sm-6 portfolio-item">
										<div id="four1" style="height:400px"></div>
									</div>
									<div class="col-md-6 col-sm-6 portfolio-item">
										<div id="four2" style="height:400px"></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div style="width: 100%;height: 100%;background-color: #580000">
						...
						<div style="height:100%;width:100%; background-color:#707070">
							<div class="container">
								...
								<div class="row" style="margin-top:  30px">
									<div class="col-md-6 col-sm-6 portfolio-item">
										<div id="five1" style="height:400px"></div>
									</div>
									<div class="col-md-6 col-sm-6 portfolio-item">
										<div id="five2" style="height:400px"></div>
									</div>
								</div>
								<button onclick="window.location.href='two.jsp'">下一页</button>
							</div>
						</div>
					</div>
				</div>
	...
	<script type="text/javascript" src="js/jslib/myhome.js"></script>
