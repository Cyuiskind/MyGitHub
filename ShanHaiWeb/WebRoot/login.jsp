...
<html>
  ...
  <!-- 因为在xml中设置url-pattern为*.action，所以必须设置action="login.action" -->
	  <form action ="user/user_login" method ="post">
	   	  <table cellspacing=5 border=0 borgercolor=#ffaa00>
		  <tr>
		  <th rowspan="3" background="images/background.jpg" style="width=90px"></th>
		  <td>用户名：</td><td><input class="message" name="username"></td></tr>
		  <tr><td>密码：</td><td><input class="message" type="password" name="userpassword"></td></tr>
