...
public class Moment implements java.io.Serializable {
	...
	public Moment(User user, String momenttype, Integer momparentid, Date momentday, Time momenttime,
			...
			String title, Set comzans, Set comzans_1) {
		this.user = user;
	...
	public Moment(Moment m1) {
		this.user = m1.user;
		this.momenttype = m1.momenttype;
		this.momentday = m1.momentday;
		this.momenttime = m1.momenttime;
		this.comentcontent = m1.comentcontent;
		this.momentimg1 = m1.momentimg1;
		this.momentimg2 = m1.momentimg2;
		this.momentimg3 = m1.momentimg3;
		this.momentimg4 = m1.momentimg4;
		this.momentimg5 = m1.momentimg5;
		this.momentimg6 = m1.momentimg6;
		this.momentimg7 = m1.momentimg7;
		this.momentimg8 = m1.momentimg8;
		this.momentimg9 = m1.momentimg9;
		this.video1 = m1.video1;
		this.video2 = m1.video2;
		this.video3 = m1.video3;
		this.likenum = m1.likenum;
		this.commentnum = m1.commentnum;
		this.sharenum = m1.sharenum;
		this.title = m1.title;
		this.comzans = m1.comzans;
		this.comzans_1 = m1.comzans_1;
	}
	
	public void setMoment(Moment m1) {
		this.user = m1.user;
		this.momenttype = m1.momenttype;
		this.momentday = m1.momentday;
		this.momenttime = m1.momenttime;
	...
	public void setshare(Moment m1) {
	//	this.user = m1.user;
		this.momenttype = "share";
	//	this.momentday = m1.momentday;
	//	this.momenttime = m1.momenttime;
		this.comentcontent = m1.comentcontent;
		this.momentimg1 = m1.momentimg1;
	...
	public void editfrom(Moment m1) {
		this.user = m1.user;
		this.momenttype = m1.momenttype;
		this.momentday = m1.momentday;
		this.momenttime = m1.momenttime;
